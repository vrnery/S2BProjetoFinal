using BagProjeto.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Web;

namespace BugProjeto1.Models
{
    public class ProjetoInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<BagContext>
    {
        protected override void Seed(BagContext context)
        {
            //base.Seed(context);
            ...
            reclamacaos.ForEach(r => context.Reclamacaos.Add(r));
            context.SaveChanges();

            var comentario = new List<Comentario>
            {
                new Comentario { ComentarioID=1, Comentario_UsuarioID=5, Comentario_ReclamacaoID=1, Descricao="Descricao1" },
                new Comentario {ComentarioID=2, Comentario_UsuarioID=6, Comentario_ReclamacaoID=2, Descricao="Descricao2" },
                new Comentario {ComentarioID=3, Comentario_UsuarioID=4, Comentario_ReclamacaoID=3, Descricao="Descricao3" }
